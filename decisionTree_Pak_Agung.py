...
# Ubah path ini sesuai dengan lokasi file kamu
...
X = df[['ph', 'Hardness', 'Turbidity', 'Solids']].values
...
# ================================
# Training dengan Decision Tree ID3
# ================================

model = DecisionTreeID3(max_depth=5)  # Kamu bisa atur max_depth sesuai kebutuhan
model.fit(X_train, y_train)

# Prediksi dan evaluasi
y_pred = model.predict(X_test)
accuracy = accuracy_score(y_test, y_pred)
print(f"Akurasi Model ID3 pada Dataset Water Potability: {accuracy * 100:.2f}%")
